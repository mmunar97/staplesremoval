...
from staplesremoval import trapezoidal_fuzzy_color_segmentation
...
if __name__ == "__main__":
    ...
    segmented_infection = trapezoidal_fuzzy_color_segmentation(inpainted_infection)
    ...
    segmented_noinfection = trapezoidal_fuzzy_color_segmentation(inpainted_noinfection)
